...
} from "../../../actions/superAdminPromosActions";
import Loader from "../../../components/Loader/Loader";

import { Trash2, Edit,ToggleRight,ToggleLeft } from "react-feather";
...
{
 params.data? params.data.status=="E"?
               <ToggleLeft
               className="mr-50"
                size={20}
                onClick={() => {
                 // let selectedData = gridApi.getSelectedRows();
                 props.updateStatusPromoCode(params.data);
                //  props.deletePromoCode(params.data.id);
                //  this.setState({ isShowLoader: true });
                  //  this.gridApi.updateRowData({ remove: selectedData })
                }}
    ...
    <div class="eventdetailsaddbox rd_noshadow rd_noboxheader">
      ...
      <div class="rd_vacationfilterpart rd_vacationfilterpart3">
                ...
                <div class="rd_profilerd_erpart">
                    ...
                    <div class="rd_vacationflex2">
                            <p>Coupon Payout Type</p>
                            <div class="rd_profilethingco">
                              <input type="text" value = {filter.filter.coupon_payout_type} name="coupon_payout_type" id="" class="rd_adddayofinput" 
                               onChange={onChange}
                              // onChange={(e) => this.updateSearchQuery(e.target.value)}
                             //  value={this.state.value}
                    ...
                    <div class="rd_vacationflex2">
                            <p>Coupon Limit</p>
                            <div class="rd_profilethingco">
                              <input type="text" value = {filter.filter.coupon_limit} name="coupon_limit" id="" class="rd_adddayofinput" 
                               onChange={onChange}
                              // onChange={(e) => this.updateSearchQuery(e.target.value)}
                             //  value={this.state.value}
                              
                              placeholder="Search by coupon limit"/>
                    ...
                    <div class="rd_vacationflex2">
                            <p>Coupon Exipry</p>
                            <div class="rd_profilethingco">
                              <input type="text" value = {filter.filter.coupon_expiry} name="coupon_expiry" id="" class="rd_adddayofinput" 
                               onChange={onChange}
                              // onChange={(e) => this.updateSearchQuery(e.target.value)}
                             //  value={this.state.value}
                              
                              placeholder="Search by expiry"/>
...
const mapStateToProps = (state) => {
  return {
    PromoCodeData: state.superadminpromos.entity,
    TotalCount: state.superadminpromos.totalCount,
    PromoCodeSuccess: state.superadminpromos.PromoCodeSuccess,
    IsDataSubmitedSuccessfullySuperAdminPromoCode:state.superadminpromos.IsDataSubmitedSuccessfullySuperAdminPromoCode
  };
};

const actionMethods = {
  getMyPromoCodeListForGrid: getMyPromoCodeListForGrid,
  deletePromoCode: deletePromoCode,
  updateStatusPromoCode:updateStatusPromoCode
};
