  ...
  render() {
    ...
    return (
      <Row className="app-user-list">
          <RegisterCustomerEdit toggleModalPreview={this.toggleModalPreview} ModalOpenPreview={this.state.ModalOpenBreaks}></RegisterCustomerEdit>
        <Col sm="12">
          <Card
...
export default RegisterCustomerList
