...
class AdminTemplates extends React.Component {
  ...
  onPreviewTemplate = (parameter) => (event) => {
    // alert()
    ...
    const accordionShadowItems = data.map((adminEmailTemplateData) => {
      return (
        <div>
          ...
          >
            <CardHeader key={adminEmailTemplateData.id}>
              <Col sm="6">
                <h4 >
                ...
                >
                  {this.state.guestUserCheckOut ? (
                    <Minus
                      size={24}
                      onClick={() =>
                        this.toggleCollapse(adminEmailTemplateData.id)
                      }
                    ></Minus>
                  ) : (
                    <Plus
            ...
            >
                    ...
                    !this.state.isEditorChangeEventCalled
                      ? EditorState.createWithContent(
                          ContentState.createFromBlockArray(
                            htmlToDraft(
                              adminEmailTemplateData.message
                                ? adminEmailTemplateData.message
                                : ""
                            )
                          )
              ...
              <Col className="d-flex justify-content-end flex-wrap" sm="12">
                ...
                <RefreshCcw
                  className="mr-1"
                  onClick={this.onResetTemplate(adminEmailTemplateData.message)}
                  id="refresh2"
                  size={23}
                />
                ...
                <Save
                  className="mr-1"
                  onClick={this.onSave(adminEmailTemplateData.id)}
                  id={adminEmailTemplateData.id}
                  size={23}
                />
                ...
                <PreviewTemplate
                  ...
                  //PreviewTemplateData={adminEmailTemplateData.message}
                  PreviewTemplateData={
