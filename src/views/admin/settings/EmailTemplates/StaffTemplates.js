...
toggleModalPreview = () => {
 ...
 componentDidMount()
 {
     this.setState({StaffEmailTemplateData:this.props.StaffEmailTemplateData})
 }
...
{this.state.guestUserCheckOut? <Minus size={24}    onClick={() => this.toggleCollapse(StaffEmailTemplateData.id)} ></Minus>
: <Plus size={24}    onClick={() => this.toggleCollapse(StaffEmailTemplateData.id)} ></Plus>
}
</label>     
            </Col>
              </CardHeader>
          ...
          /></CardBody>
                ...
                <Tag size={23} id="tag3" className="mr-1" onClick={this.toggleModal}/>
            ...
            <RefreshCcw className="mr-1" id="refresh3" size={23}/>
            <UncontrolledTooltip
                  placement="top"
                  target="refresh3"
                >
            ...
            <Save className="mr-1" onClick={this.onSave(StaffEmailTemplateData.id)} id={StaffEmailTemplateData.id} size={23} />
         
            <Eye onClick={this.toggleModalPreview} id="preview3" className="mr-1" size={23}/>
            <UncontrolledTooltip
                  placement="top"
                  target="preview3"
                >
