...
class SMSTemplate extends React.Component {
  ...
  componentDidUpdate(prevProps,prevSate)
  {
    if(this.props!=prevProps)
    {
     ...
     this.setState({clientTemplates:this.props.SmsTemplateObject.clientTemplates});
     this.setState({adminTemplates:this.props.SmsTemplateObject.adminTemplates})
     this.setState({staffTemplates:this.props.SmsTemplateObject.staffTemplates})
            ...
            <CardBody className="pt-2">
              <Nav tabs>
                <NavItem>
                  ...
                  >
                    <User size={16} />
                    <span className="align-middle ml-50">Client Sms Templates</span>
                  </NavLink>
                </NavItem>
                <NavItem>
                  <NavLink
                  ...
                  >
                    <Info size={16} />
                    <span className="align-middle ml-50">Admin Sms Templates</span>
                  </NavLink>
                </NavItem>
              ...
              <TabContent activeTab={this.state.activeTab}>
               ...
               <TabPane tabId="1">
               { this.state.clientTemplates.map((clientSmsTemplateData, index) => (
                  <div>
               <ClientSmsTemplate clientSmsTemplateData={clientSmsTemplateData}/>
               </div>
               ))}
                </TabPane>
                <TabPane tabId="2">
                { this.state.adminTemplates.map((adminSmsTemplateData, index) => (
                  <div>
               <AdminSmsTemplate adminSmsTemplateData={adminSmsTemplateData}/>
               </div>
               ))}
