                  ...
                  <Row>
                    <Col sm="12" className="mt-1">
                        ...
                        <Label className="react-toggle-wrapper d-inline-block align-middle">
                          <Toggle
                            cancellationPolicyChecked={
                              this.state.isCancellationPolicyChecked
                            }
                            formikprops={formikprops}
                          />
                        </Label>
                      ...
                      <div className="d-inline-block mb-1 mr-1">
                        ...
                        <Label className="react-toggle-wrapper d-inline-block align-middle">
                          <Toggle
                            allowMultipleBookingChecked={
                              this.state.isAllowMultipleBookingChecked
                            }
                            formikprops={formikprops}
                          />
                        </Label>
                        ...
                        <Label className="react-toggle-wrapper d-inline-block align-middle">
                          <Toggle
                            termsConditionsChecked={
                              this.state.isTermsConditionsChecked
                            }
                            formikprops={formikprops}
                          />
                        </Label>
                        ...
                        <Label className="react-toggle-wrapper d-inline-block align-middle">
                          <Toggle
                            privacyPolicyChecked={
                              this.state.isPrivacyPolicyChecked
                            }
                            formikprops={formikprops}
                          />
                        </Label>
