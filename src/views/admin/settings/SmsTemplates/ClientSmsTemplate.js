    ...
    const accordionShadowItems = data.map((clientSmsTemplateData) => {
      return (
        <div>
          ...
          >
            <CardHeader key={clientSmsTemplateData.id}>
              <Col sm="6">
                ...
                >
                  {this.state.guestUserCheckOut ? (
                    <Minus
                      size={24}
                      onClick={() =>
                        this.toggleCollapse(clientSmsTemplateData.id)
                      }
                    ></Minus>
                  ) : (
                    <Plus
            ...
            >
                    ...
                    !this.state.isEditorChangeEventCalled
                      ? EditorState.createWithContent(
                          ContentState.createFromBlockArray(
                            htmlToDraft(
                              clientSmsTemplateData.sms_message
                                ? clientSmsTemplateData.sms_message
                                : ""
                            )
                          )
              ...
              <Col className="d-flex justify-content-end flex-wrap" sm="12">
                ...
                <Save
                  className="mr-1"
                  onClick={this.onSave(clientSmsTemplateData.id)}
                  id=""
                  size={23}
                />
