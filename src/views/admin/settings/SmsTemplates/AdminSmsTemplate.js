...
{this.state.guestUserCheckOut? <Minus size={24}    onClick={() => this.toggleCollapse(adminSmsTemplateData.id)} ></Minus>
: <Plus size={24}    onClick={() => this.toggleCollapse(adminSmsTemplateData.id)} ></Plus>
}
</label>     
            </Col>
              </CardHeader>
          ...
          /></CardBody>
            ...
            <Save className="mr-1" onClick={this.onSave(adminSmsTemplateData.id)} id={adminSmsTemplateData.id}  size={23} />
