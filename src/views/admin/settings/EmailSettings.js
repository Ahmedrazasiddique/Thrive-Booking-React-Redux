...
import {
  ...
  CustomInput,
  Media,
  UncontrolledTooltip,Form} from "reactstrap";
  import { ToastContainer, toast } from "react-toastify";
  import {  Lock ,HelpCircle,Calendar,Mail,Send,Server,Trash} from "react-feather"
  import Toggle from "react-toggle"
  import { connect } from "react-redux";
  import {getEmailSettingsData ,updateEmailSettingsData } from "../../../actions/emailSettingsAction";
  ...
  const EmailSettings =(props)=>
  {
    ...
    const handleSubmit = (event) => {
      ...
      formData.append('smtp_auth_status', smtpNotificationChk==true?"E":"D");
      formData.append('admin_email_notification_status', adminEmailNotificationChk==true?"E":"D");  
      formData.append('client_email_notification_status', clientEmailNotificationChk==true?"E":"D");
      formData.append('staff_email_notification_status', staffEmailNotificationChk==true?"E":"D");  
      let reminders= reminderComponent.forEach(function(v){ delete v.id;delete v.created_at;delete v.updated_at });
     // formData.append('reminders', JSON.stringify(reminderComponent)); 
      formData.append('business_id', 1);// need to get from local storage
  ...
  useEffect(() => {
    ...
    setAdminEmailNotificationChk(props.EmailSettingsData.admin_email_notification_status=="E"?true:false)
    setClientEmailNotificationChk(props.EmailSettingsData.client_email_notification_status=="E"?true:false)
    setStaffEmailNotificationChk(props.EmailSettingsData.staff_email_notification_status=="E"?true:false)
    setSmtpNotificationChk(props.EmailSettingsData.smtp_auth_status=="E"?true:false)
    ...
    }else
    {
               ...
               const DeleteReminder =(event)=>{
                ...
                setReminderComponent(reminderComponent.filter(item => item.email_config_id !== name));
    ...
    const AddReminder = (event)=>{   
        ...
        setReminderComponent(state=>[...state,{
  ...
  <Loader isShowLoader={isShowLoader}></Loader>
        ...
        <CardBody>
            ...
            <FormGroup row>
              ...
              <Col sm="8">
              <Input type="select"   onChange={handleInputChange} value={EmailSettingsData.encryption_type} name="encryption_type" id="encryption_type">
            <option>Plain</option>
            <option>TLS</option>
            <option>SSL</option>
            ...
            <FormGroup row>
              <Col sm="4">
                <h5>Smtp Authentication <HelpCircle size={12} /></h5>
              </Col>
              <Col sm="8">
            ...
            <FormGroup row>
              <Col sm="4">
                <h5>Admin Email <HelpCircle size={12} /> Notification</h5>
              </Col>
              <Col sm="8">
              <label className="react-toggle-wrapper">
            <Toggle
            ...
            <FormGroup row>
              <Col sm="4">
                <h5>Client Email <HelpCircle size={12} /> Notification</h5>
              </Col>
              <Col sm="8">
              <label className="react-toggle-wrapper">
            <Toggle
            ...
            <FormGroup row>
              <Col sm="4">
                <h5>Staff Email <HelpCircle size={12} /> Notification</h5>
              </Col>
              <Col sm="8">
              <label className="react-toggle-wrapper">
            <Toggle
  ...
  {reminderComponent?reminderComponent.map((value,index,) => ( 
                  <FormGroup row>
              ...
              <Col sm="6">
                  ...
                  <Input type="select"  id={"reminder_type"}   onChange={handleInputReminder(index)} value={value.reminder_type}
                         >
            ...
            <option value="M">minute/s before</option>
              ...
              <Col sm="1">
                  {index!=0?
              <Trash id="deleteReminder" name={value.email_config_id} onClick={DeleteReminder} size={19} />
              :<></>
                  }
            ...
            <FormGroup row>
              ...
              <Col sm="8">
              <Button.Ripple onClick={AddReminder} className="mr-1" color="primary">
              + Add Reminder
            </Button.Ripple>
              </Col>
            </FormGroup>
