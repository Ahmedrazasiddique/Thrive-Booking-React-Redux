...
import { getEventData,updateEventData } from "../../../actions/eventSettingsActions";
...
class EventSettings extends React.Component {
  ...
  componentDidMount()
  {
    let dataDays=[];
    for(let i = 1; i< 31; i++) {
        dataDays.push({value:i+" Days",label:i+" Days"});
        
        }
        let datahours=[];
        for(let i = 1; i< 25; i++) {
          datahours.push({value:i+" Hours",label:i+" Hours"});
            
            }
            let minutes=[];
            for(let i = 1; i< 61; i++) {
                minutes.push({value:i+" Minutes",label:i+" Minutes"});
  ...
  componentDidUpdate(prevProps,prevSate)
  {
    if(this.props!=prevProps)
    {
     ...
     this.setState({isShowLoader:false}); this.setState({EventSuccessLocal:true});
     this.setState({guestUserCheckOut:this.state.EventData.guest_user_checkout_status=="E"?true:false});
 ...
 //   };
  ...
  <Loader isShowLoader={this.state.isShowLoader }></Loader>
       ...
       {  this.state.EventSuccessLocal ?
              <Form onSubmit={this.handleSubmit}>
               ...
               <Col sm="6">
                <div className="permissions border px-2">
                  ...
                  <FormGroup row>
              <Col sm="3">
                <h5>Default Interval  <HelpCircle id="defaultIntervalTp" size={12} /> Time</h5> 
                <UncontrolledTooltip
                  placement="top"
              ...
              nameDD={["","default_interval_time_hours","default_interval_time_minutes"] }
            ...
            <FormGroup row>
              <Col sm="3">
                <h5>Cancellation  <HelpCircle size={12} /> Buffer Time</h5>
              </Col>
              <Col sm="9">
              <CustomTimePicker 
              isDaysToShow={true}
              nameDD={["cancellation_buffer_time_days","cancellation_buffer_time_hours","cancellation_buffer_time_minutes"] }
              ValDD={this.state.EventData} 
              disabled={false}
              dataDays={this.state.dataDays}
              datahours={this.state.datahours}
            ...
            <FormGroup row>
              ...
              <Col sm="9">
              <CustomTimePicker isDaysToShow={true}
                nameDD={["reschedule_buffer_time_days","reschedule_buffer_time_hours","reschedule_buffer_time_minutes"] }
                ValDD={this.state.EventData} 
              disabled={false}
              dataDays={this.state.dataDays}
              datahours={this.state.datahours}
            ...
            <FormGroup row>
              ...
              isDaysToShow={true} 
              disabled={false}
              nameDD={["min_adv_booking_time_days","min_adv_booking_time_hours","min_adv_booking_time_minutes"] }
              ValDD={this.state.EventData} 
              dataDays={this.state.dataDays}
              datahours={this.state.datahours}
              minutes={this.state.minutes}
            ...
            <FormGroup row>
              ...
              isDaysToShow={true}
               disabled={false}
               nameDD={["max_adv_booking_time_days","max_adv_booking_time_hours","max_adv_booking_time_minutes"] }
               ValDD={this.state.EventData} 
               dataDays={this.state.dataDays}
               datahours={this.state.datahours}
               minutes={this.state.minutes}
            ...
            <FormGroup row>
              <Col sm="3">
                <h5>Guest User <HelpCircle size={12} /> Checkout</h5>
              </Col>
              <Col sm="9">
            ...
            />
              ...
              <Col sm="3">
                <h5>Time Format <HelpCircle size={12} /></h5>
              </Col>
              <Col sm="4">
              <Select
                   ...
                   defaultValue={{value:this.state.EventData.time_format,label:this.state.EventData.time_format}}
            ...
            <FormGroup row>
              <Col sm="3">
                <h5>Date Picker <HelpCircle size={12} />  Format </h5>
              </Col>
              <Col sm="4">
              <Select
                   ...
                   classNamePrefix="select"
                   defaultValue={{value:this.state.EventData.date_picker_format,label:this.state.EventData.date_picker_format}}
            ...
            <FormGroup row>
              ...
              <Select
                        ...
                        classNamePrefix="select"
                        defaultValue={{value:this.state.EventData.calendar_default_view,label:this.state.EventData.calendar_default_view}}
            ...
            <FormGroup row>
              <Col sm="3">
                <h5>Calendar First Day <HelpCircle size={12} /> </h5>
              </Col>
              <Col sm="4">
              <Select
                   ...
                   classNamePrefix="select"
                   defaultValue={{value:this.state.EventData.calendar_first_day,label:this.state.EventData.calendar_first_day}}
