          ...
          <Card>
            <CardBody className="pt-2">
              ...
              <NavItem>
                  ...
                  >
                    <DollarSign size={16} />
                    <span className="align-middle ml-50">Recurrent Discounts</span>
                  </NavLink>
                </NavItem>
                <NavItem>
                  <NavLink
              ...
              <TabPane tabId="1">
               ...
               <TabPane tabId="2">
               <PromoCodeList onEditClick={this.editClickPromoCode}></PromoCodeList>
                </TabPane>
                <TabPane tabId="3">
                  <Col sm="6">
             <AddNewPromoCode  PromoRecord={this.state.promoCode?this.state.promoCode:{}}></AddNewPromoCode>
             </Col>
                </TabPane>
                <TabPane tabId="4">
                <Col sm="6">
