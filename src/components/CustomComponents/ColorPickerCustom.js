...
class ColorPickerCustom extends React.Component {
  ...
  render() {
    ...
    return (
        ...
        <Badge pill style={styles.color} onClick={ this.handleClick } className="badge-sd">
        <span>{this.props.text}</span>
        <input type="hidden" value={JSON.stringify(this.state.color)} name={this.props.colorFormName}  ></input>
      </Badge>
