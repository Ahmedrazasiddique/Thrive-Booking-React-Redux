      ...
      <Card>
        ...
        <CardBody>
          <Button
            className="mr-1 mb-1"
            color="primary"
            onClick={() => this.handleAlert("imgAlert", true)}
            outline
          >
            Image
          </Button>
          <Button
            className="mr-1 mb-1"
            color="primary"
            onClick={() => this.handleAlert("timerAlert", true)}
            outline
          >
            Timeout
          </Button>
          <Button
            className="mr-1 mb-1"
            color="primary"
            onClick={() => this.handleAlert("overlayAlert", true)}
            outline
          >
            Overlay
          </Button>
          <Button
            className="mr-1 mb-1"
            color="primary"
            onClick={() => this.handleAlert("outsideClickAlert", true)}
            outline
          >
            Outside Click
          </Button>
          <Button
            className="mb-1"
            color="primary"
            onClick={() => this.handleAlert("inputAlert", true)}
            outline
          >
            Input Alert
          </Button>
          ...
          >
            <p className="sweet-alert-text">I will close in 2 seconds.</p>
          </SweetAlert>
          ...
          >
            <p className="sweet-alert-text">Write something interesting:</p>
          </SweetAlert>
        </CardBody>
      </Card>
    );
