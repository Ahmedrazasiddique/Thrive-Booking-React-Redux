...
class PayUmoneyModal extends React.Component {
  state = {
    modal: false,
  };
      ...
      <React.Fragment>
        <Card>
          ...
          <CardBody>
            ...
            >
              <ModalHeader toggle={this.toggleModal}>PayUmoney</ModalHeader>
              <ModalBody>
