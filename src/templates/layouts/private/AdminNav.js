  ...
  render() {
    return (
      <React.Fragment>
        ...
        <Settings toggleSettings={this.onToggleSettings} settingState={this.state.showSettings} />
          ...
          <div
            ...
            <div className="navbar-container main-menu-content">
              ...
              onMouseLeave={() => this.handleItemHover(null)}>
                ...
                <a className="nav-link horizontal-nav-link" href="/admin/dashboard">
                  <Icon.Home size="16"/>
              ...
              <li className={classnames('nav-item', {
                hover: this.state.itemHover === "my-calendar"
              })}
              onMouseEnter={() => this.handleItemHover("my-calendar")}
              onMouseLeave={() => this.handleItemHover(null)}>

                <a className="nav-link horizontal-nav-link" href="test">
                  <Icon.Calendar size="16" />
                  <span className="menu-title align-middle"> My Calendar</span>
                </a>
              </li>

              <li className={classnames('nav-item', {
                hover: this.state.itemHover === "my-booking"
              })}
              onMouseEnter={() => this.handleItemHover("my-booking")}
              onMouseLeave={() => this.handleItemHover(null)}>

                <a className="nav-link horizontal-nav-link" href="test">
                  <Icon.Book size="16" />
                  <span className="menu-title align-middle"> My Booking</span>
                </a>
              </li>
                ...
                <li className={classnames('nav-item', {
                hover: this.state.itemHover === "my-booking-page"
              })}
              onMouseEnter={() => this.handleItemHover("my-booking-page")}
              onMouseLeave={() => this.handleItemHover(null)}>


                  <a className="nav-link" href="test">
                    <Icon.Book size="16" />
                    <span className="menu-title align-middle"> My Booking Page</span>
                  </a>
                </li>
